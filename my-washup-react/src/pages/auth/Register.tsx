    ...
    <>
      ...
      <div className="auth-page-bg">
        <div className="auth-card">
          <img src="/image/logowashup.png" alt="WASH UP Logo" className="auth-logo" />
          <h2 className="auth-title">สมัครสมาชิกใหม่</h2>

          <form onSubmit={handleRegister} autoComplete="off"> {/* ✅ ป้องกัน Browser จำค่าเดิมแบบ Auto-fill */}
            ...
            <div className="input-group-clean">
              ...
              <p className="password-hint">
                * ต้องมีอย่างน้อย 8 ตัวอักษร, พิมพ์ใหญ่ 1 ตัว และอักขระพิเศษ 1 ตัว (!@#$%)
              </p>
            </div>
